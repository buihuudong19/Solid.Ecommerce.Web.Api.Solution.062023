...
namespace Solid.Ecommerce.Shared.EntityModels.SqlServer.DBContext;

public partial class SolidStoreContext : DbContext
{
    public SolidStoreContext()
    {
    }

    public SolidStoreContext(DbContextOptions<SolidStoreContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        /*
                ...
                => optionsBuilder.UseSqlServer("server =localhost; database = SolidStore;uid=sa;pwd=sa;Trustservercertificate=true", x => x
                        .UseNetTopologySuite()
                        .UseHierarchyId());
         */
    }
